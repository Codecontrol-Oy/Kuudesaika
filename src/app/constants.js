...
export const CASE_FETCH = 'CASE_FETCH';
export const CASE_FETCH_PENDING = 'CASE_FETCH_PENDING';
export const CASE_FETCH_REJECTED = 'CASE_FETCH_REJECTED';
export const CASE_FETCH_FULFILLED = 'CASE_FETCH_FULFILLED';
